...
import dncnn_data_generator as dg
from dncnn_data_generator import DenoisingDataset
...
parser.add_argument('--train_data', default='data/denoising_train_data/Train400',
...
save_dir = os.path.join('denoiser_models', args.model + '_' + 'sigma' + str(sigma))
